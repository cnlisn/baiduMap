package com.baidu.lisn.baidumap.overlayutil;
...
import com.baidu.lisn.baidumap.app;
import com.baidu.lisn.baidumap.overlayutil.OverlayManager;
...
public class WalkingRouteOverlay extends OverlayManager {
    ...
    public boolean onRouteNodeClick(int i) {
        if (mRouteLine.getAllStep() != null
            ...
            Log.i("baidumapsdk", "WalkingRouteOverlay onRouteNodeClick"+
                    mRouteLine.getAllStep().get(i).getInstructions()); //获取路段整体指示信息 
            String instructions = mRouteLine.getAllStep().get(i).getInstructions();//获取路段整体指示信息
            Toast.makeText(app.getInstance(), instructions, Toast.LENGTH_SHORT).show();
